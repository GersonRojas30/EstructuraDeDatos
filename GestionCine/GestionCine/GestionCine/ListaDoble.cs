...
namespace GestionCine
{
    public class ListaDoble
    {
        ...
        public void MostrarFormatoLista()
        {
            if (cabeza == null)
            {
                Console.WriteLine("La lista de películas está vacía.");
                return;
            }
            ...
            do
            {
                Console.Write($"{actual.Datos.Nombre} -> ");
                actual = actual.Siguiente; // Avanzamos al siguiente nodo
            } while (actual != cabeza); // Detenemos cuando regresamos al inicio
